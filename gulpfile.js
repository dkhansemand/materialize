...
gulp.task('htmlpage', () => {
	var htmlSrc = './src/*.html',
		htmlDst = './build',
		scripts = gulp.src(['./build/assets/scripts/jquery.min.js', 
                            './build/assets/scripts/materialize.min.js',
                            './build/assets/scripts/app.js'], 
                            {read: false}),

		css = gulp.src(['./build/assets/stylesheets/materialize.min.css',
                        './build/assets/stylesheets/font-awesome.min.css',
